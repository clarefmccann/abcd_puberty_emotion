...
for sex in sexes:
    for subset in subsets:
        ...
        for predictor in predictors:
            ...
            mycleandf_puberty['{}_{}_abcd'.format(predictor, subset)] = ypuberty_pred
            mycleandf_puberty['{}_{}_gap_abcd'.format(predictor, subset)] = ypuberty_gap

            mycleandf_puberty["{}_{}_abcd_rtm".format(predictor, subset)] = remove_regression_to_mean_effect(
                mycleandf_puberty['age'], mycleandf_puberty["{}_{}_abcd".format(predictor, subset)]
            )

            mycleandf_puberty["{}_{}_abcd_gap_rtm".format(predictor, subset)] = \
                mycleandf_puberty["{}_{}_abcd_rtm".format(predictor, subset)] - mycleandf_puberty["age"]

            mycleandf_puberty.to_csv(
                r'/u/project/silvers/data/ABCD/cfm_flux_2023/puberty_age_gap/data/mycleandf_{}_gap_abcd_{}_{}.csv'.format(predictor, sex, subset),
            ...
            mycleandf_puberty.to_csv(
                r'/u/project/silvers/data/ABCD/cfm_flux_2023/puberty_age_gap/data/mycleandf_pds_age_regressgap_without_{}_{}.csv'.format(
                    sex, subset),
                index=True, header=True)
