...
for sex in sexes:
    ...
    for predictor in predictors:
        ...
        outputname = '/u/project/silvers/data/ABCD/cfm_flux_2023/puberty_age_gap/data/models/final_{}_abcd_{}_model.sav'.format(predictor, sex)
